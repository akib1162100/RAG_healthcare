...
export class QuickCreateWebsiteSystray extends Component {
    setup() {
        ...
        this.is_sh_quick_create = session.sh_quick_create
    ...
    async getActionItems(props) {
        ajax.jsonRpc("/get/quick/action/data", "call", {
        }).then((result) => {
    ...
    RecordEditQuickAction(ev,action_id){
        ...
        ajax.jsonRpc("/get/edit/quick/action/data", "call", {
            action_id:action_id
        }).then((result) => {
    ...
    async DeleteNewAction(){
        await ajax.jsonRpc("/unlink/quick/action/data", "call", {
    ...
    async SaveAction(){
        ...
        // FOR SAVE AFTER EDIT
            ...
            ajax.jsonRpc("/update/quick/action", "call", {
                'data': formData,
                'action_id': this.state.CurrentEditId,
              }).then((result) => {
                this.getActionItems()
        ...
        // FOR SAVE WHEN NEW CREATE
            ...
            $('#quick_create_errors_msg').addClass('d-none');
            ajax.jsonRpc("/create/quick/action", "call", {
                'data': formData,
              }).then((result) => {
                this.getActionItems()
            });
