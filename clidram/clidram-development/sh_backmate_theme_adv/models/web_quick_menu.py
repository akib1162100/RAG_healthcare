...
class res_users(models.Model):
    ...
    sh_enable_recent_record_view = fields.Boolean("Enable Recent Record View")
    sh_quick_create = fields.Boolean('Quick Create',default=False)

    @property
    def SELF_READABLE_FIELDS(self):
        return super().SELF_READABLE_FIELDS + ['sh_quick_create','sh_enable_recent_record_view','sh_disable_auto_edit_model','sh_enable_todo_mode','sh_enable_quick_menu_mode','sh_enable_gloabl_search_mode','sh_enable_night_mode', 'sh_enable_language_selection','sh_enable_zoom','sh_enable_multi_tab','sh_enable_full_screen_mode','sh_enable_calculator_mode','sh_enable_expand_collapse','show_attachment_in_list_view','sh_enable_open_record_in_new_tab']

    @property
    def SELF_WRITEABLE_FIELDS(self):
            return super().SELF_WRITEABLE_FIELDS + ['sh_quick_create','sh_enable_recent_record_view','sh_disable_auto_edit_model','sh_enable_todo_mode','sh_enable_quick_menu_mode','sh_enable_gloabl_search_mode','sh_enable_night_mode', 'sh_enable_language_selection','sh_enable_zoom','sh_enable_multi_tab','sh_enable_full_screen_mode','sh_enable_calculator_mode','sh_enable_expand_collapse','show_attachment_in_list_view','sh_enable_open_record_in_new_tab']
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        info["sh_quick_create"] = user.sh_quick_create
        return info
