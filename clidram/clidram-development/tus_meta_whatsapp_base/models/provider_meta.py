                        ...
                        for component in template['components']:
                            ...
                            if component['type'] == 'BUTTONS' and component['buttons']:
                                ...
                                for button in component['buttons']:
                                    ...
                                    if button['type'] == 'PHONE_NUMBER':
                                    ...
                                    elif button['type'] == 'URL' and not button.get('example'):
                                        button_dict.update({
                                            'button_type': 'url',
                                            'button_text': button_text,
                                            'url_type': 'static',
                                            'static_website_url': button.get('url', '')
                                        })
                                    elif button['type'] == 'URL' and button.get('example'):
                                        button_dict.update({
                                            'button_type': 'url',
                                            'button_text': button_text,
                                            'url_type': 'dynamic',
                                            'dynamic_website_url': button.get('url', '')
                                        })
                                        ...
                                        button_dict.update({
                                            ...
                                            'button_text': button_text,
                                            'coupon_text': (button.get('example') or [''])[0]
                                        })
                                    button_list.append(button_dict)

                                component_list.append((0, 0, {
                                    'type': 'buttons',
                                    'wa_button_ids': [(5, 0, 0)] + [(0, 0, button_vals) for button_vals in button_list]
                                }))
