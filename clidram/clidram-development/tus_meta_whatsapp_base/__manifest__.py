{
    'name': 'Odoo WhatsApp Base | Odoo WhatsApp Integration with Official WhatsApp Cloud API by Meta',
    'version': '16.2.1',
    ...
    'price': 99,
    'currency': 'USD',
    'summary': 'Odoo WhatsApp Integration with Official WhatsApp Cloud API by Meta',
    'description': """
